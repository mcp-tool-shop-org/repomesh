...
सार्वजनिक कुंजी PEM को अपने `node.json` रखरखाव प्रविष्टि में रखें।
निजी कुंजी को GitHub रिपो गुप्त (`REPOMESH_SIGNING_KEY`) के रूप में संग्रहीत करें।
...
| `KeyRotation` | एक अनुरक्षक कुंजी को एक उत्तराधिकारी में घुमाया जाता है (संभावित — पिछली हस्ताक्षर मान्य रहते हैं)। |
| `KeyRevocation` | एक अनुरक्षक कुंजी रद्द कर दी जाती है (समझौता = पूर्वव्यापी अमान्यता, RFC 5280)। |
...
अनुरक्षक कुंजियों का एक जीवनचक्र होता है। किसी कुंजी को एक उत्तराधिकारी में घुमाया जा सकता है या उसे रद्द किया जा सकता है, और सत्यापन समय के प्रति संवेदनशील होता है: किसी हस्ताक्षर पर तभी भरोसा किया जाता है जब वह हस्ताक्षर के विश्वसनीय समय पर कुंजी मान्य थी — XRPL एंकर क्लोज-टाइम, वही विश्वसनीय घड़ी जिसका उपयोग लेज़र पहले से करता है।
...
- **नियमित रोटेशन** संभावित होता है — सेवानिवृत्त कुंजी के पिछले हस्ताक्षर मान्य रहते हैं; यह केवल नए संस्करणों पर हस्ताक्षर करना बंद कर देता है।
- **समझौता** पूर्वव्यापी होता है (RFC 5280 §5.3.2) — किसी भी ऐसे हस्ताक्षर को अस्वीकार कर दिया जाता है जिसका सिद्ध एंकर समय अमान्यता तिथि पर या उसके बाद का हो, और एक ऐसा हस्ताक्षर जिसे इससे पहले सिद्ध नहीं किया जा सकता है, उसे भी अस्वीकार कर दिया जाता है।
- जीवनचक्र क्षेत्रों के बिना एक कुंजी को पिछली पीढ़ी की माना जाता है (हमेशा मान्य), इसलिए मौजूदा नोड अपरिवर्तित रूप से सत्यापित करते हैं।
- निरसन पर `KeyRevocation` घटनाओं पर हस्ताक्षर किए जाते हैं; एक एकल-कुंजी नोड जिसकी एकमात्र कुंजी समझौता कर ली गई है, उसे एक **शासन** (`trustedPolicy`) नोड द्वारा निरसन पर हस्ताक्षर करके ठीक किया जाता है। विश्वास-महत्वपूर्ण नोड्स को **≥2 कुंजियाँ** पंजीकृत करनी चाहिए (TUF §6.1)।
- छेड़छाड़ किए गए `node.json` के खिलाफ भी, एक निरसन को हस्ताक्षरित, XRPL-एन्कर घटनाओं से फिर से लागू किया जाता है — एक हटाए गए मेनिफेस्ट रद्द की गई कुंजी को पुनर्जीवित नहीं कर सकता। सीमा के लिए [धमकी मॉडल](docs/threat-model.md) देखें (मानक लेज़र के विरुद्ध सत्यापित करें; निरसन-संवेदनशील जाँचों के लिए `--anchored` का उपयोग करें)।
...
RepoMesh **लेज़र घटनाओं** (हस्ताक्षरित JSON), **नोड मेनिफेस्ट** (सार्वजनिक कुंजियाँ + क्षमताएँ), **रजिस्ट्री सूचकांक** (स्वचालित रूप से उत्पन्न विश्वास स्कोर), और **XRPL टेस्टनेट** (एंकर लेनदेन) को प्रभावित करता है। यह सदस्य रिपॉजिटरी स्रोत कोड, निजी कुंजियों, उपयोगकर्ता क्रेडेंशियल्स या ब्राउज़िंग डेटा को **नहीं** छूता है। निजी हस्ताक्षर कुंजियाँ कभी भी CI रनर को नहीं छोड़ती हैं। नेटवर्क एक्सेस GitHub API (PR निर्माण), XRPL टेस्टनेट (एंकरिंग) और OSV.dev (भेद्यता लुकअप) तक सीमित है। कोई **टेलीमेट्री** एकत्र या भेजी नहीं जाती है — शून्य विश्लेषिकी, शून्य क्रैश रिपोर्ट, शून्य फोन-होम। पूर्ण दायरे, आवश्यक अनुमतियों और भेद्यता रिपोर्टिंग प्रक्रिया के लिए [SECURITY.md](SECURITY.md) देखें, और कुंजी-जीवनचक्र विश्वास सीमा के लिए [धमकी मॉडल](docs/threat-model.md) देखें (क्यों `node.json` की प्रामाणिकता इसके स्रोत पर निर्भर करती है, और क्यों निरसन-संवेदनशील सत्यापन को `--anchored` का उपयोग करना चाहिए)।
