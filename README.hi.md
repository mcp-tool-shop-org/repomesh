...
नए **जाँच प्रकार** और **सत्यापन नोड** डेटा को संपादित करके जोड़े जाते हैं, न कि कोड में बदलाव करके। जाँच-प्रकार रजिस्ट्री, स्कोरिंग भार और नोड-प्रकार की अनुमतियाँ यहाँ मौजूद हैं: [`verifier.policy.json`](verifier.policy.json) (स्कीमा द्वारा मान्य, विफल होने पर बंद)। एक जाँच जोड़ना (जैसे `sast.scan`) लगभग 6 पंक्तियों वाली नीति में बदलाव + एक `node.json` है, जिसकी समीक्षा एक पुल अनुरोध में की जाती है — इसमें कोई कोड परिवर्तन नहीं होता।

एक अपरिवर्तनीय नियम: **पंजीकृत ≠ विश्वसनीय।** पंजीकरण एक जाँच को भाग लेने देता है; लेकिन क्रेडिट के लिए अभी भी एक विश्वसनीय सेट की सहमति आवश्यक है। विस्तृत मार्गदर्शिका: [docs/verifier-plugin-contract.md](docs/verifier-plugin-contract.md)।
