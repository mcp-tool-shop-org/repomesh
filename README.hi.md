...
RepoMesh **लेजर घटनाओं** (हस्ताक्षरित JSON), **नोड मेनिफेस्ट** (सार्वजनिक कुंजियाँ + क्षमताएँ), **रजिस्ट्री सूचकांक** (स्वचालित रूप से उत्पन्न ट्रस्ट स्कोर) और **एक्सआरपीएल टेस्टनेट** (एंकर लेनदेन) को छूता है। यह सदस्य रिपॉजिटरी स्रोत कोड, निजी कुंजियों, उपयोगकर्ता क्रेडेंशियल्स या ब्राउज़िंग डेटा को नहीं छूता है। निजी हस्ताक्षर कुंजियाँ कभी भी सीआई रनर को नहीं छोड़ती हैं। नेटवर्क एक्सेस गिटहब एपीआई (पीआर निर्माण), एक्सआरपीएल टेस्टनेट (एंकरिंग) और ओएसवी.देव (भेद्यता लुकअप) तक सीमित है। **कोई टेलीमेट्री** एकत्र या भेजी नहीं जाती है - शून्य एनालिटिक्स, शून्य क्रैश रिपोर्ट, शून्य फोन-होम। पूर्ण दायरे, आवश्यक अनुमतियों और भेद्यता रिपोर्टिंग प्रक्रिया के लिए [SECURITY.md](SECURITY.md) देखें।
